...
int main(int argc, char* argv[])
{
   ...
   if(runType == "Topology" || runType == "Gamma" || runType == "Sigma_gamma" || runType == "Gamma_approx" || runType == "Sigma_gamma_approx")
   {
      ...
      else if(runType == "Gamma_approx")
      {
         wds->calculateVulnerabilityApprox();
         wFile << wds->globalGammaDemand << '\n';
      }
      else if(runType == "Sigma_gamma_approx")
      {  
         wds->calculateVulnerabilityApprox();
         double sigma = standardDeviation(wds->localGammaDemand);
         wFile << sigma << '\n';
      }
   }
   wFile.close();
