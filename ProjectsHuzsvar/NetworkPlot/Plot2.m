...
colorMapName = 'prism'; 
colorBarText = 'Szegmens sorszáma, 1';
...
% for i=1:2
    ...
    PlotPool(pool(i).coordX,pool(i).coordY,tankSize,1,poolAngle(i),[r,g,b],join([strrep(pool(i).ID,'_','\_'),'  ',text]));
end
