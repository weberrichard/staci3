...
% caseName = 'balf';
% caseName = 'sanchegy';
% caseName = 'sanchegy_extended';
% caseName = 'becsidomb';
% caseName = 'villasor';
% caseName = 'villasor_extended';
% caseName = 'villasor_extended_Longest';
% caseName = 'Anytown';
% caseName = 'Anytown_extended';
% caseName = 'tomalom';
% caseName = 'NewYork';
% caseName = 'FER-CSAPDV-1-input_mod';
% plot settings
pumpRadius = 0.01;
presRadius = 0.015;
tankSize = 0.02;
