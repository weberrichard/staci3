...
int main(int argc, char* argv[])
{
   ...
   if(runType == "Topology" || runType == "Gamma" || runType == "Sigma_gamma" || runType == "gamma_distribution" || runType == "get_Topology" || runType == "get_ValvePlacement")
   {
      ...
      else if(runType == "get_ValvePlacement")
      {
         wds->calculateVulnerability();
         cout << "megvan" << endl;
         wds->saveResult("userOutput","Node");
         wds->saveResult("userOutput","Pipe");
         wds->saveSystem("Tomalom_Valve");
      }
