...
public:
	...
	void solve_init()
	{
		...
		Chronometer timer;
		timer.tic();
		cout << "itt tart most1" << endl;
		thisGenerationType generation0;
		cout << "itt tart most2" << endl;
		init_population(generation0);
		cout << "itt tart most3" << endl;
		generation_step=0;
